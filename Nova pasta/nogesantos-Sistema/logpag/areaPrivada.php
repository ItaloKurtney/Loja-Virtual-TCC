...
<link rel="stylesheet" href="privestilo.css">
...
<body>
    <header>
        <a href="#" class="logo"><img src="img/logoss.png">
    ...
    <div class="profile">
        ...
        <br>
        <a href="crud/index.html" target="_blank">Marcar Limpeza</a>
        <br>
        <a href="http://localhost/nogesantos/pdcad/formcad.php" target="_blank">CadastrarProduto</a>
    </div>
    ...
    <section class="home swipe"id="home">
        <div class="swiper-wrapper">
            <div class="swiper-slide conteiner">
                ...
                <a href="#categories" class="btn">Começe Agora</a><i class='bx bx-right-arrow-alt'></i></a>
            </div>
...
?>
            <!--Prod1-->
            <div class="box">
                <img src="pdcad<?php echo $arquivo ?>" alt="" class="largura-img">
                <h2><?php echo $nome; ?></h2>
                <h3 class="price"><?php echo $preco; ?><br>10x<br><?php echo $codigo; ?><span>/unidade</span></h3>
                <a href="/nogesantos/produto.php?id=<?php echo $id ?>" target="_blank"><h4>Compre aqui</h4></a>
            </div>
